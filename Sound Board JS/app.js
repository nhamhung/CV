...
const specialButton = document.querySelector("#musicButton");
specialButton.addEventListener('mousedown', () => {
    soundPress(specialButton, document.querySelector("#happyBirthday"));
});

specialButton.addEventListener('mouseup', () => {
    specialButton.style.background = "#562349";
});
